/****************************************************************************
 * boards/arm/gd32h73x_75x/gd32h759im-eval/src/gd32h73x_75x_bringup.c
 *
...
#ifdef CONFIG_GD32H73X_75X_ROMFS
#include "gd32h73x_75x_romfs.h"
#endif
...
#  ifdef HAVE_GD25
      ...
      if (ret < 0)
        {
          syslog(LOG_ERR,
                 "ERROR: Failed to mount GD25 SPI flash: %d\n", ret);
        }
