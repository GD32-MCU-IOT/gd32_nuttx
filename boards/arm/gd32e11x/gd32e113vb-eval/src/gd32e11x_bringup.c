...
#ifdef CONFIG_GD32E11X_ROMFS
#include "gd32e11x_romfs.h"
#endif
      ...
      if (ret < 0)
        {
          syslog(LOG_ERR, "ERROR: Failed to mount romfs at %s: %d\n",
                CONFIG_GD32E11X_ROMFS_MOUNTPOINT, ret);
        }
#endif

#ifndef CONFIG_DISABLE_MOUNTPOINT

#  ifdef CONFIG_GD32E11X_PROGMEM

      /* Create an instance of the GD32E11X FLASH program memory
       * device driver
       */
...
#    if defined(CONFIG_FS_NXFFS)
      ...
      ret = nx_mount(NULL, CONFIG_GD32E11X_NXFFS_MOUNTPT, "nxffs", 0, NULL);
      if (ret < 0)
        {
