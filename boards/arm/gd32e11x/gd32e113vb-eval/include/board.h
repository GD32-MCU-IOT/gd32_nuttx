...
#  define GPIO_USART0_RX (GPIO_USART0_RX_1 | GPIO_CFG_MODE_OSPEED_50MHZ)
#  define GPIO_USART0_TX (GPIO_USART0_TX_1 | GPIO_CFG_MODE_OSPEED_50MHZ)

#if defined(CONFIG_SERIAL_IFLOWCONTROL) && defined(CONFIG_USART0_IFLOWCONTROL)
#    define GPIO_USART0_RTS (GPIO_USART0_RTS | GPIO_CFG_MODE_OSPEED_50MHZ)
#  endif
#if defined(CONFIG_SERIAL_OFLOWCONTROL) && defined(CONFIG_USART0_OFLOWCONTROL)
#    define GPIO_USART0_CTS (GPIO_USART0_CTS | GPIO_CFG_MODE_OSPEED_50MHZ)
#  endif
#endif
...
#  define GPIO_USART1_RX (GPIO_USART1_RX_1 | GPIO_CFG_MODE_OSPEED_50MHZ)
#  define GPIO_USART1_TX (GPIO_USART1_TX_1 | GPIO_CFG_MODE_OSPEED_50MHZ)
#endif
