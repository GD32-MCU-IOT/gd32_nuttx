...
#  define GPIO_SPI0_SCK_PIN  (GPIO_SPI0_SCK_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI0_MISO_PIN (GPIO_SPI0_MISO_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI0_MOSI_PIN (GPIO_SPI0_MOSI_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI0_CSPIN    (GPIO_CFG_OUTPUT | GPIO_CFG_CTL_OUTPP | \
                              GPIO_CFG_SPEED_50MHZ | GPIO_CFG_OUTPUT_SET | \
                              GPIO_CFG_PORT_E | GPIO_CFG_PIN_3)
#endif

#ifdef CONFIG_GD32E11X_SPI1
#  define GPIO_SPI1_SCK_PIN  (GPIO_SPI1_SCK_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI1_MISO_PIN (GPIO_SPI1_MISO_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI1_MOSI_PIN (GPIO_SPI1_MOSI_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI1_CSPIN    (GPIO_CFG_OUTPUT | GPIO_CFG_CTL_OUTPP | \
                              GPIO_CFG_SPEED_50MHZ | GPIO_CFG_OUTPUT_SET | \
                              GPIO_CFG_PORT_E | GPIO_CFG_PIN_4)
#endif

#ifdef CONFIG_GD32E11X_SPI2
#  define GPIO_SPI2_SCK_PIN  (GPIO_SPI2_SCK_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI2_MISO_PIN (GPIO_SPI2_MISO_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI2_MOSI_PIN (GPIO_SPI2_MOSI_1 | GPIO_CFG_SPEED_50MHZ)
#  define GPIO_SPI2_CSPIN    (GPIO_CFG_OUTPUT | GPIO_CFG_CTL_OUTPP | \
                              GPIO_CFG_SPEED_50MHZ | GPIO_CFG_OUTPUT_SET | \
