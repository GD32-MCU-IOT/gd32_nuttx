/****************************************************************************
 * arch/arm/src/gd32h73x_75x/gd32h73x_75x_i2c.c
 *
...
#ifdef CONFIG_GD32H73X_75X_I2C_DMA
#  include "gd32h73x_75x_dma.h"
#endif

#include <nuttx/cache.h>

#ifdef CONFIG_GD32H73X_75X_I2C
...
#ifndef CONFIG_GD32H73X_75X_I2C_TIMEOSEC
#  define CONFIG_GD32H73X_75X_I2C_TIMEOSEC 0
#endif

#ifndef CONFIG_GD32H73X_75X_I2C_TIMEOMS
#  define CONFIG_GD32H73X_75X_I2C_TIMEOMS  500
#endif

#if CONFIG_GD32H73X_75X_I2C_TIMEOSEC == 0 && CONFIG_GD32H73X_75X_I2C_TIMEOMS == 0
#  error "I2C timeout must be non-zero"
#endif

#define I2C_TIMEOUT_TICKS \
  MSEC2TICK(CONFIG_GD32H73X_75X_I2C_TIMEOSEC * 1000 + CONFIG_GD32H73X_75X_I2C_TIMEOMS)

#ifdef CONFIG_GD32H73X_75X_I2C_DMA
#  ifndef CONFIG_GD32H73X_75X_I2C_DMATHRESHOLD
#    define CONFIG_GD32H73X_75X_I2C_DMATHRESHOLD 4
#  endif
...
#if defined(CONFIG_GD32H73X_75X_I2C_DMA) && defined(CONFIG_ARMV7M_DCACHE)
#  ifdef CONFIG_GD32H73X_75X_I2C0_DMA
static uint8_t g_i2c0_rxbuf[I2C_DMA_BUFSIZE] I2C_DMA_BUF_ALIGN;
#  endif
#  ifdef CONFIG_GD32H73X_75X_I2C1_DMA
static uint8_t g_i2c1_rxbuf[I2C_DMA_BUFSIZE] I2C_DMA_BUF_ALIGN;
#  endif
#  ifdef CONFIG_GD32H73X_75X_I2C2_DMA
static uint8_t g_i2c2_rxbuf[I2C_DMA_BUFSIZE] I2C_DMA_BUF_ALIGN;
#  endif
#  ifdef CONFIG_GD32H73X_75X_I2C3_DMA
...
#ifdef CONFIG_GD32H73X_75X_I2C0
...
#ifdef CONFIG_GD32H73X_75X_I2C1
...
#ifdef CONFIG_GD32H73X_75X_I2C2
...
#ifdef CONFIG_GD32H73X_75X_I2C3
 ...
 *   GD32H73x_75x uses TIMING register with PSC, SCLL, SCLH, SDADELY,
 *   SCLDELY.
 *
...
#if defined(CONFIG_I2C_POLLED) || defined(CONFIG_GD32H73X_75X_I2C_DMA)
/****************************************************************************
...
#endif /* CONFIG_I2C_POLLED || CONFIG_GD32H73X_75X_I2C_DMA */
 ...
 *   transfer function for the GD32H73x_75x new-style I2C peripheral.
 *
 *   For each message:
...
#endif /* CONFIG_GD32H73X_75X_I2C_DMA */
                             ...
                             struct i2c_msg_s *msgs, int count)
{
  ...
  if (count == 1 && !(msgs[0].flags & I2C_M_READ) &&
      msgs[0].length >= CONFIG_GD32H73X_75X_I2C_DMATHRESHOLD &&
      priv->txdma != NULL)
    {
           ...
           priv->rxdma != NULL)
    {
      ...
      ret = gd32_i2c_dma_read(priv, &msgs[0]);
           ...
           msgs[1].length >= CONFIG_GD32H73X_75X_I2C_DMATHRESHOLD &&
           priv->rxdma != NULL)
    {
