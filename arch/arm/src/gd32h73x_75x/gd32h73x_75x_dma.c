/****************************************************************************
 * arch/arm/src/gd32h73x_75x/gd32h73x_75x_dma.c
 *
 ...
 * Note: DMA IRQs may not be contiguous on GD32H73x_75x.
 */
