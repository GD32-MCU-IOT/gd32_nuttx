/****************************************************************************
 * arch/arm/src/gd32h73x_75x/gd32h73x_75x_serial.c
 *
...
#if defined(CONFIG_PM) && !defined(CONFIG_GD32H73X_75X_PM_SERIAL_ACTIVITY)
#  define CONFIG_GD32H73X_75X_PM_SERIAL_ACTIVITY 10
#endif
...
/* USART DMA priority */
#if defined(CONFIG_GD32H73X_75X_USART_PRIQ)
#  define USART_DMA_PRIO  CONFIG_GD32H73X_75X_USART_PRIQ
#else
 ...
 */
#  if !defined(CONFIG_GD32H73X_75X_SERIAL_RXDMA_BUFFER_SIZE)
#    define CONFIG_GD32H73X_75X_SERIAL_RXDMA_BUFFER_SIZE 32
#  endif
#  if defined(CONFIG_ARMV7M_DCACHE)
#    define RXDMA_BUFFER_MASK   (ARMV7M_DCACHE_LINESIZE - 1)
#    define RXDMA_BUFFER_SIZE   ((CONFIG_GD32H73X_75X_SERIAL_RXDMA_BUFFER_SIZE \
...
static void up_dma_shutdown(struct uart_dev_s *dev);
    ...
    defined(CONFIG_GD32H73X_75X_SERIALBRK_BSDCOMPAT)
...
#elif defined(CONFIG_GD32H73X_75X_USART0_RXDMA) && !defined(CONFIG_GD32H73X_75X_USART0_TXDMA)
...
#if defined(CONFIG_GD32H73X_75X_USART1_RXDMA) && defined(CONFIG_GD32H73X_75X_USART1_TXDMA)
  .ops      = &g_uart_ops_rxtx_dma,
...
#if defined(CONFIG_GD32H73X_75X_USART2_RXDMA) && defined(CONFIG_GD32H73X_75X_USART2_TXDMA)
  .ops      = &g_uart_ops_rxtx_dma,
...
#if defined(CONFIG_GD32H73X_75X_USART5_RXDMA) && defined(CONFIG_GD32H73X_75X_USART5_TXDMA)
  .ops      = &g_uart_ops_rxtx_dma,
...
#if defined(CONFIG_GD32H73X_75X_UART3_RXDMA) && defined(CONFIG_GD32H73X_75X_UART3_TXDMA)
  .ops      = &g_uart_ops_rxtx_dma,
...
#if defined(CONFIG_GD32H73X_75X_UART4_RXDMA) && defined(CONFIG_GD32H73X_75X_UART4_TXDMA)
  .ops      = &g_uart_ops_rxtx_dma,
...
#if defined(CONFIG_GD32H73X_75X_UART6_RXDMA) && defined(CONFIG_GD32H73X_75X_UART6_TXDMA)
  .ops      = &g_uart_ops_rxtx_dma,
...
#if defined(CONFIG_GD32H73X_75X_UART7_RXDMA) && defined(CONFIG_GD32H73X_75X_UART7_TXDMA)
  .ops      = &g_uart_ops_rxtx_dma,
...
static void gd32_usart_configure(struct uart_dev_s *dev)
{
  ...
  !defined(CONFIG_GD32H73X_75X_FLOWCONTROL_BROKEN)
...
#ifdef CONFIG_GD32H73X_75X_FLOWCONTROL_BROKEN
...
#if defined(CONFIG_PM) && CONFIG_GD32H73X_75X_PM_SERIAL_ACTIVITY > 0
  /* Report serial activity to the power management logic */

  pm_activity(PM_IDLE_DOMAIN, CONFIG_GD32H73X_75X_PM_SERIAL_ACTIVITY);
#endif
...
#endif
#if defined(CONFIG_SERIAL_TERMIOS) || defined(CONFIG_GD32H73X_75X_SERIALBRK_BSDCOMPAT)
  struct up_dev_s   *priv  = (struct up_dev_s *)dev->priv;
#endif
  uint32_t regval;
  int      ret    = OK;
...
#ifdef CONFIG_GD32H73X_75X_USART_SINGLEWIRE
...
#ifdef CONFIG_GD32H73X_75X_USART_BREAKS
#  ifdef CONFIG_GD32H73X_75X_SERIALBRK_BSDCOMPAT
...
#ifdef CONFIG_GD32H73X_75X_USART_INVERT
    case TIOCSINVERT:
      {
        uint32_t regaddr;
        irqstate_t flags;
...
#ifndef CONFIG_GD32H73X_75X_SERIAL_DISABLE_REORDERING
