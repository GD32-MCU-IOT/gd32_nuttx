/****************************************************************************
 * arch/arm/src/gd32h73x_75x/gd32h73x_75x_spi.c
 *
 ...
 * common GD32H73x_75x logic.  To use this common SPI logic on your board:
 *
...
#if defined(CONFIG_GD32H73X_75X_SPI0) || defined(CONFIG_GD32H73X_75X_SPI1) || \
    defined(CONFIG_GD32H73X_75X_SPI2) || defined(CONFIG_GD32H73X_75X_SPI3) || \
    defined(CONFIG_GD32H73X_75X_SPI4) || defined(CONFIG_GD32H73X_75X_SPI5)
...
#ifndef CONFIG_GD32H73X_75X_SPI_TIMEOUTMS
#  define CONFIG_GD32H73X_75X_SPI_TIMEOUTMS 500
#endif

#define SPI_TIMEOUT_TICKS       MSEC2TICK(CONFIG_GD32H73X_75X_SPI_TIMEOUTMS)

/* SPI DMA definitions */

#ifdef CONFIG_GD32H73X_75X_SPI_DMA
...
#  if defined(CONFIG_GD32H73X_75X_SPI0_DMA_BUFFER) && \
      CONFIG_GD32H73X_75X_SPI0_DMA_BUFFER > 0
#    define SPI0_DMA_BUFSIZE_ADJ   ((CONFIG_GD32H73X_75X_SPI0_DMA_BUFFER + \
                                     SPI_DMA_BUFFER_MASK) & ~SPI_DMA_BUFFER_MASK)
#  endif

#  if defined(CONFIG_GD32H73X_75X_SPI1_DMA_BUFFER) && \
      CONFIG_GD32H73X_75X_SPI1_DMA_BUFFER > 0
#    define SPI1_DMA_BUFSIZE_ADJ   ((CONFIG_GD32H73X_75X_SPI1_DMA_BUFFER + \
                                     SPI_DMA_BUFFER_MASK) & ~SPI_DMA_BUFFER_MASK)
#  endif

#  if defined(CONFIG_GD32H73X_75X_SPI2_DMA_BUFFER) && \
      CONFIG_GD32H73X_75X_SPI2_DMA_BUFFER > 0
#    define SPI2_DMA_BUFSIZE_ADJ   ((CONFIG_GD32H73X_75X_SPI2_DMA_BUFFER + \
                                     SPI_DMA_BUFFER_MASK) & ~SPI_DMA_BUFFER_MASK)
#  endif

#  if defined(CONFIG_GD32H73X_75X_SPI3_DMA_BUFFER) && \
      CONFIG_GD32H73X_75X_SPI3_DMA_BUFFER > 0
#    define SPI3_DMA_BUFSIZE_ADJ   ((CONFIG_GD32H73X_75X_SPI3_DMA_BUFFER + \
                                     SPI_DMA_BUFFER_MASK) & ~SPI_DMA_BUFFER_MASK)
#  endif

#  if defined(CONFIG_GD32H73X_75X_SPI4_DMA_BUFFER) && \
      CONFIG_GD32H73X_75X_SPI4_DMA_BUFFER > 0
#    define SPI4_DMA_BUFSIZE_ADJ   ((CONFIG_GD32H73X_75X_SPI4_DMA_BUFFER + \
                                     SPI_DMA_BUFFER_MASK) & ~SPI_DMA_BUFFER_MASK)
#  endif

#  if defined(CONFIG_GD32H73X_75X_SPI5_DMA_BUFFER) && \
      CONFIG_GD32H73X_75X_SPI5_DMA_BUFFER > 0
#    define SPI5_DMA_BUFSIZE_ADJ   ((CONFIG_GD32H73X_75X_SPI5_DMA_BUFFER + \
                                     SPI_DMA_BUFFER_MASK) & ~SPI_DMA_BUFFER_MASK)
#  endif

#  ifndef CONFIG_GD32H73X_75X_SPI_DMATHRESHOLD
#    define CONFIG_GD32H73X_75X_SPI_DMATHRESHOLD 4
#  endif
#endif /* CONFIG_GD32H73X_75X_SPI_DMA */
...
#ifdef CONFIG_GD32H73X_75X_SPI_INTERRUPTS
...
#ifdef CONFIG_GD32H73X_75X_SPI0
...
#endif
#ifdef CONFIG_GD32H73X_75X_SPI_DMA
#  ifdef CONFIG_GD32H73X_75X_SPI0_DMA
...
#ifdef CONFIG_GD32H73X_75X_SPI1
...
#endif
#ifdef CONFIG_GD32H73X_75X_SPI_DMA
#  ifdef CONFIG_GD32H73X_75X_SPI1_DMA
...
#ifdef CONFIG_GD32H73X_75X_SPI2
...
#endif
#ifdef CONFIG_GD32H73X_75X_SPI_DMA
#  ifdef CONFIG_GD32H73X_75X_SPI2_DMA
...
#ifdef CONFIG_GD32H73X_75X_SPI3
...
#endif
#ifdef CONFIG_GD32H73X_75X_SPI_DMA
#  ifdef CONFIG_GD32H73X_75X_SPI3_DMA
...
#ifdef CONFIG_GD32H73X_75X_SPI4
...
#endif
#ifdef CONFIG_GD32H73X_75X_SPI_DMA
#  ifdef CONFIG_GD32H73X_75X_SPI4_DMA
...
#ifdef CONFIG_GD32H73X_75X_SPI5
...
#endif
#ifdef CONFIG_GD32H73X_75X_SPI_DMA
#  ifdef CONFIG_GD32H73X_75X_SPI5_DMA
...
static inline uint8_t spi_getreg8(struct gd32_spidev_s *priv,
                                  uint32_t offset)
{
  /* GD32H73x_75x device memory requires 32-bit aligned access.
 ...
 *   GD32H73x_75x requires suspend (MSPDR) before disable if master is
 *   active.
 *
 ****************************************************************************/
 ...
 *   GD32H73x_75x uses TXSIZE=1 mode so that MSTART auto-clears after the
 ...
 *   GD32H73x_75x: Use TXSIZE mode with MSTART for precise transfer control.
 *
 ****************************************************************************/
...
#if !defined(CONFIG_GD32H73X_75X_SPI_DMA)
static void spi_exchange(struct spi_dev_s *dev, const void *txbuffer,
                         void *rxbuffer, size_t nwords)
#else
                         ...
                         void *rxbuffer, size_t nwords)
{
  ...
  if ((priv->rxdma == NULL) || (priv->txdma == NULL) ||
      ...
      (nbytes <= CONFIG_GD32H73X_75X_SPI_DMATHRESHOLD))
    {
...
#if defined(CONFIG_GD32H73X_75X_SPI3) || defined(CONFIG_GD32H73X_75X_SPI4)
...
#endif /* CONFIG_GD32H73X_75X_SPI0 || ... || CONFIG_GD32H73X_75X_SPI5 */
