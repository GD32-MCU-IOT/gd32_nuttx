/****************************************************************************
 * arch/arm/src/gd32h73x_75x/gd32h73x_75x_allocateheap.c
 *
 ...
 *      Define CONFIG_GD32H73X_75X_DTCMEXCLUDE to exclude the DTCM from
 *      heap and use AXI SRAM as primary heap instead.
 *
...
#ifndef CONFIG_GD32H73X_75X_DTCMEXCLUDE
...
#ifdef CONFIG_GD32H73X_75X_DTCMEXCLUDE
#  undef HAVE_DTCM
#endif

/* Check if we will have additional memory regions */

#if !defined(CONFIG_GD32H73X_75X_DTCMEXCLUDE) || defined(CONFIG_ARCH_HAVE_HEAP2)
