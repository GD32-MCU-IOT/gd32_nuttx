...
#define GD32_USBFS_DIEPTFLEN_OFFSET(n) (0x0100 + ((n) << 2))
...
#define GD32_USBFS_DIEPTFLEN(n)        (GD32_USBFS_BASE + GD32_USBFS_DIEPTFLEN_OFFSET(n))
#  define GD32_USBFS_DIEP1TFLEN        GD32_USBFS_DIEPTFLEN(1)
#  define GD32_USBFS_DIEP2TFLEN        GD32_USBFS_DIEPTFLEN(2)
#  define GD32_USBFS_DIEP3TFLEN        GD32_USBFS_DIEPTFLEN(3)
...
/* DIEPTFLEN (n=1..3) - Device IN endpoint n TxFIFO length */

#define USBFS_DIEPTFLEN_IEPTXRSAR_SHIFT (0)
#define USBFS_DIEPTFLEN_IEPTXRSAR_MASK  (0xffff << USBFS_DIEPTFLEN_IEPTXRSAR_SHIFT)
#define USBFS_DIEPTFLEN_IEPTXFD_SHIFT   (16)
#define USBFS_DIEPTFLEN_IEPTXFD_MASK    (0xffff << USBFS_DIEPTFLEN_IEPTXFD_SHIFT)
