/****************************************************************************
 * arch/arm/src/gd32e11x/hardware/gd32e11x_usart.h
 *
...
#ifndef __ARCH_ARM_SRC_GD32E11X_HARDWARE_GD32E11X_USART_H
#define __ARCH_ARM_SRC_GD32E11X_HARDWARE_GD32E11X_USART_H
...
#define GD32_USART1_BASE       (GD32_USART_BASE+0x00000000U)         /* USART1 base address */
#define GD32_USART2_BASE       (GD32_USART_BASE+0x00000400U)         /* USART2 base address */
#define GD32_UART3_BASE        (GD32_USART_BASE+0x00000800U)         /* UART3 base address */
#define GD32_UART4_BASE        (GD32_USART_BASE+0x00000c00U)         /* UART4 base address */
#define GD32_USART0_BASE       (GD32_USART_BASE+0x0000f400U)         /* USART0 base address */
...
#define GD32_USART_STAT0_OFFSET        0x0000  /* Status register 0 */
#define GD32_USART_DATA_OFFSET         0x0004  /* Data register */
#define GD32_USART_BAUD_OFFSET         0x0008  /* Baud rate register */
#define GD32_USART_CTL0_OFFSET         0x000c  /* Control register 0 */
#define GD32_USART_CTL1_OFFSET         0x0010  /* Control register 1 */
#define GD32_USART_CTL2_OFFSET         0x0014  /* Control register 2 */
#define GD32_USART_GP_OFFSET           0x0018  /* Guard time and prescaler register */
#define GD32_USART_CTL3_OFFSET         0x0080  /* Control register 3 */
#define GD32_USART_RT_OFFSET           0x0084  /* Receiver timeout register */
#define GD32_USART_STAT1_OFFSET        0x0088  /* Status register 1 */
#define GD32_USART_CHC_OFFSET          0x00c0  /* Coherence control register */
...
#define GD32_USART_CTL3(usartx)        ((usartx)+GD32_USART_CTL3_OFFSET)     /* USART control register 3 */
...
#define USART_STAT0_PERR               (1 << 0)   /* Parity error flag */
#define USART_STAT0_FERR               (1 << 1)   /* Frame error flag */
#define USART_STAT0_NERR               (1 << 2)   /* Noise error flag */
#define USART_STAT0_ORERR              (1 << 3)   /* Overrun error */
#define USART_STAT0_IDLEF              (1 << 4)   /* IDLE frame detected flag */
#define USART_STAT0_RBNE               (1 << 5)   /* Read data buffer not empty */
#define USART_STAT0_TC                 (1 << 6)   /* Transmission complete */
#define USART_STAT0_TBE                (1 << 7)   /* Transmit data buffer empty */
#define USART_STAT0_LBDF               (1 << 8)   /* LIN break detection flag */
#define USART_STAT0_CTSF               (1 << 9)   /* CTS change flag */
...
#define USART_DATA_MASK                (0x1ff << USART_DATA_SHIFT)
...
#define USART_CTL1_LBDIE               (1 << 6)   /* Bit 6: LIN break detection interrupt enable */
...
#endif /* __ARCH_ARM_SRC_GD32E11X_HARDWARE_GD32E11X_USART_H */
