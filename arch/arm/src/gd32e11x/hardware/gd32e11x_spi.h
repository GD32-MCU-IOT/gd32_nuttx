/****************************************************************************
 * arch/arm/src/gd32e11x/hardware/gd32e11x_spi.h
 *
...
#ifndef __ARCH_ARM_SRC_GD32E11X_HARDWARE_GD32E11X_SPI_H
#define __ARCH_ARM_SRC_GD32E11X_HARDWARE_GD32E11X_SPI_H
...
#define GD32_SPI0_BASE             (GD32_APB2_BUS_BASE + 0x00003000)  /* SPI0 base address: 0x40013000 */
#define GD32_SPI1_BASE             (GD32_APB1_BUS_BASE + 0x00003800)  /* SPI1 base address: 0x40003800 */
#define GD32_SPI2_BASE             (GD32_APB1_BUS_BASE + 0x00003C00)  /* SPI2 base address: 0x40003C00 */
...
#define SPI_CTL1_NSSP              (1 << 3)            /* Bit 3: NSS pulse mode enable (GD32E11x specific) */
...
#define SPI_CRCPOLY_CPR_MASK       (0xffff << SPI_CRCPOLY_CPR_SHIFT)

/* Receive CRC register (SPI_RCRC) */

#define SPI_RCRC_RCR_SHIFT         (0)                 /* Bits 0-15: RX CRC register */
#define SPI_RCRC_RCR_MASK          (0xffff << SPI_RCRC_RCR_SHIFT)

/* Transmit CRC register (SPI_TCRC) */
...
#  define SPI_I2SCTL_DTLEN_DT24B   SPI_I2SCTL_DTLEN(1) /* 01: 24 bits */
#  define SPI_I2SCTL_DTLEN_DT32B   SPI_I2SCTL_DTLEN(2) /* 10: 32 bits */
...
#  define SPI_I2SSTD_MSB           SPI_I2SCTL_I2SSTD(1)    /* 01: MSB justified standard */
#  define SPI_I2SSTD_LSB           SPI_I2SCTL_I2SSTD(2)    /* 10: LSB justified standard */
#  define SPI_I2SSTD_PCM           SPI_I2SCTL_I2SSTD(3)    /* 11: PCM standard*/

#define SPI_I2SCTL_PCMSMOD         (1 << 7)            /* Bit 7: PCM frame synchronization mode */

#define SPI_I2SCTL_I2SOPMOD_SHIFT  (8)                 /* Bit 8-9: I2S operation mode */
#define SPI_I2SCTL_I2SOPMOD_MASK   (3 << SPI_I2SCTL_I2SOPMOD_SHIFT)
#define SPI_I2SCTL_I2SOPMOD(n)     ((n) << SPI_I2SCTL_I2SOPMOD_SHIFT)
...
#define SPI_I2SPSC_DIV_SHIFT       (0)                 /* Bit 0-7: dividing factor for the prescaler */
...
#define SPI_I2SPSC_OF              (1 << 8)            /* Bit 8: odd factor for the prescaler */
#define SPI_I2SPSC_MCKOEN          (1 << 9)            /* Bit 9: I2S MCK output enable */

/* SPI quad mode control register (SPI_QCTL) - Only for SPI0 */

#define SPI_QCTL_QMOD              (1 << 0)            /* Bit 0: quad-SPI mode enable */
#define SPI_QCTL_QRD               (1 << 1)            /* Bit 1: quad-SPI mode read select */
#define SPI_QCTL_IO23_DRV          (1 << 2)            /* Bit 2: drive SPI_IO2 and SPI_IO3 enable */
...
#define SPI_TRANSMODE_FULLDUPLEX   (0x00000000)                        /* SPI receive and send data at fullduplex communication */
#define SPI_TRANSMODE_RECEIVEONLY  SPI_CTL0_RO                         /* SPI only receive data */
#define SPI_TRANSMODE_BDRECEIVE    SPI_CTL0_BDEN                       /* bidirectional receive data */
#define SPI_TRANSMODE_BDTRANSMIT   (SPI_CTL0_BDEN | SPI_CTL0_BDOEN)    /* bidirectional transmit data*/

#endif /* __ARCH_ARM_SRC_GD32E11X_HARDWARE_GD32E11X_SPI_H */
