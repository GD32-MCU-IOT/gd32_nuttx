/****************************************************************************
 * arch/arm/src/gd32e11x/gd32e11x_spi.c
 *
 ...
 * must be provided by board-specific logic.  They are implementations
 ...
 * common GD32E11X logic.  To use this common SPI logic on your board:
 *
...
#if defined(CONFIG_GD32E11X_SPI0) || defined(CONFIG_GD32E11X_SPI1) || \
    defined(CONFIG_GD32E11X_SPI2)
...
#ifdef CONFIG_GD32E11X_SPI_INTERRUPT
...
#  define SPI_DMA_PRIO  CONFIG_GD32E11X_SPI_PRIQ
#else
...
#  if defined(CONFIG_GD32E11X_SPI0_DMA_BUFFER) && CONFIG_GD32E11X_SPI0_DMA_BUFFER > 0
#    define SPI0_DMA_BUFSIZE_ADJ   ((CONFIG_GD32E11X_SPI0_DMA_BUFFER + SPI_DMA_BUFFER_MASK) & \
                                    ~SPI_DMA_BUFFER_MASK)
#  endif

#  if defined(CONFIG_GD32E11X_SPI1_DMA_BUFFER) && CONFIG_GD32E11X_SPI1_DMA_BUFFER > 0
#    define SPI1_DMA_BUFSIZE_ADJ   ((CONFIG_GD32E11X_SPI1_DMA_BUFFER + SPI_DMA_BUFFER_MASK) & \
                                    ~SPI_DMA_BUFFER_MASK)
#  endif

#  if defined(CONFIG_GD32E11X_SPI2_DMA_BUFFER) && CONFIG_GD32E11X_SPI2_DMA_BUFFER > 0
#    define SPI2_DMA_BUFSIZE_ADJ   ((CONFIG_GD32E11X_SPI2_DMA_BUFFER + SPI_DMA_BUFFER_MASK) & \
                                    ~SPI_DMA_BUFFER_MASK)
#  endif
 ...
 *   FIFOs and (2) the gd32e11x F3 data packing.
 *
 * Input Parameters:
 *   dev      - Device-specific state data
...
#if !defined(CONFIG_GD32E11X_SPI_DMA) || defined(CONFIG_GD32E11X_SPI_DMATHRESHOLD)
#if !defined(CONFIG_GD32E11X_SPI_DMA)
...
#ifdef CONFIG_GD32E11X_SPI_DMATHRESHOLD
  /* If this is a small SPI transfer, then let spi_exchange_nodma()
   * work do the.
   */

  || (nbytes <= CONFIG_GD32E11X_SPI_DMATHRESHOLD)
#endif
      )
    {
