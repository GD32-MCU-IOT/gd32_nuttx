/****************************************************************************
 * arch/arm/src/gd32e11x/gd32e11x_spi.h
 *
...
#ifndef __ARCH_ARM_SRC_GD32E11X_GD32E11X_SPI_H
#define __ARCH_ARM_SRC_GD32E11X_GD32E11X_SPI_H
...
#include "chip.h"
#include "hardware/gd32e11x_spi.h"
...
/****************************************************************************
 * Name:  gd32_spi[n]select, gd32_spi[n]status, and gd32_spi[n]cmddata
 *
 * Description:
 ...
 *   gd32_spibus_initialize()) are provided by common GD32E11x logic.
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_GD32E11X_GD32E11X_SPI_H */
